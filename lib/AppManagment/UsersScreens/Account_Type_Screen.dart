          ...
          child: SingleChildScrollView(
            child: Column(
                ...
                children: <Widget>[
                  ...
                  Container(child: Image.asset("assets/images/newlogologo.jpeg",
                      ...
                      child: Column(
                          children: <Widget>[
                            ...
                            ElevatedButton(
                              ...
                              onPressed: () async {
                                List<dynamic> citiesList = await Userbg
                                    .getCities();
                                ...
                                DocumentSnapshot isTeacher = await Teacher.getTeacherById(this.userObj.id);
                                if (isTeacher.exists){
                                print(isTeacher["subjects"]);


                                Teacher teacher = new Teacher(isTeacher["email"], "", "", isTeacher["FullName"], isTeacher["BirthDate"], isTeacher["PhoneNumber"], isTeacher["Location"], isTeacher["subjects"], isTeacher["More"], isTeacher["ProfileImg"], isTeacher["Rating"],isTeacher["CanGo"],isTeacher.id,isTeacher["Title Sentence"],isTeacher["Price"]);

                                Navigator.of(context).pushReplacement(SlideRightRoute(
                                page: TeacherHomepage(teacher,s,"","",this.auth,this.googleSignIn,false)
