            ...
            child: Column(children: <Widget>[
                    ...
                    IconButton(
                        ...
                        onPressed: () async {
                          try {
                            ...
                            print(
                                "problem with getting the subjects or the cities or navigator in line 92 Search_For_Teacher_Result_Second_Screen.dart");
                          }
                        }),
                    Column(children: [
                      SizedBox(
                      ...
                      Image.asset("assets/images/newlogologo.jpeg",
                          matchTextDirection: true, height: 50, width: 120),
                      Text(
                        'TeachMe',
                        style: TextStyle(
                            fontFamily: 'Kaushan',
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    Text(
                      this.widget.selectedSubject != null
                          ? this.widget.selectedSubject
                          : "Subject",
                      style: TextStyle(
                          color: Colors.blue,
                          fontSize: 50,
              ...
              SingleChildScrollView(
                  child: Container(
                      ...
                      child: TeachersList(
                          this.widget.selectedSubject,
                          this.widget.selectedLocation,
                          this.widget.s,
                          this.widget.auth,
                          this.widget.googleSignIn,
                          this.widget.teacherCan)))
            ]),
          ),
        ),
      ),
